...
//}
//
//// I USED STRINGS IN DISPLAY SO CHANGE TO CHAR ARR PLS
////ALSO MAKE IT CASE INSENSITIVE ( i need to make a case insensitive char comparer e.g. for insertion)
//// consider using dynamic arrays for searchbox etc (20 MIGHT BE TOO SMALL RIP)
//// make a suggestions class? to contain all the suggestions stuff instead of directly in console
